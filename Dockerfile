...
COPY dashboard_bridge.py bot_config.py derive_and_update_keys.py derive_keys.py fetch_balance.py redeem_positions.py cli_dashboard.py test_auth.py live_preflight.py polymarket_fees.py ./
